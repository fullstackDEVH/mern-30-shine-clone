...
const Booking = () => {
  ...
  const handleStep = (step: number) => {
    if (step === 3) {
      document
        .querySelector("#box-time .booking-body__box_contain")
  ...
  return (
    <div className="booking">
      <div className="booking-contain">
        ...
        {
          [
            <MainScreen handleStep={handleStep} infor={infor} />,
            <SalonScreen />,
            <ServicesScreen />,
          ][step]
        }
        ...
        {step === 0 ? (
          <div className="booking-fixed">
            <div className="booking-fixed__contain">
              <div
                className={`booking-fixed__contain_btn ${
                  infor.salon && infor.time && "--done"
                }`}
              >
                Hoàn tất
              </div>
